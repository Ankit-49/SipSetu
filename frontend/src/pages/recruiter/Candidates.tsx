      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-4">
          {selectedJob === "all-jobs" ? (
            ...
            return (
            <Card key={candidate.ranking_id} className={`overflow-hidden hover:shadow-md transition-all duration-300 animate-in fade-in slide-in-from-bottom-2 ${status === "shortlisted" ? "ring-1 ring-yellow-300/60" : status === "rejected" ? "opacity-60" : ""}`} style={{ animationDelay: `${i * 50}ms` }}>
