    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and view your recruiter updates and applicant activities.</p>
        </div>
          ...
          {notifications.length === 0 ? (
            <div className="py-16 px-4 text-center">
              ...
              <p className="text-slate-400 text-sm mt-1 max-w-sm mx-auto">
                You're all caught up! Notifications regarding job postings or candidate applications will appear here.
              </p>
            </div>
          ) : (
              ...
              {notifications.map((n) => (
                <div
                  ...
                  className={`p-5 flex gap-4 transition-all duration-200 hover:bg-slate-50/80 ${
                    !n.is_read ? "bg-blue-50/20 border-l-4 border-l-[#1E3A5F]" : "border-l-4 border-l-transparent"
                  }`}
                >
                  <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 border bg-blue-50 border-blue-100`}>
